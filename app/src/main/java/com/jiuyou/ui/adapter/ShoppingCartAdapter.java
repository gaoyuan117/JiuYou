...
//    int num;// 商品数量
    ...
    static class ViewHolder { // 自定义控件集合
        ...
        public RoundImageView pic_goods;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            itemView.pic_goods = (RoundImageView) convertView
        ...
        Glide.with(context).load(AppConfig.ENDPOINTPIC+test.getMasterImg()).placeholder(R.mipmap.icon_nopic).into(itemView.pic_goods);
        return convertView;
    }
