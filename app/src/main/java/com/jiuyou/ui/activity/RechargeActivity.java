...
public class RechargeActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    ...
    private String currentMoney="20";
    ...
    private void initView(){
        ...
        AppContext.getInstance().getImageLoader().displayImage(AppConfig.ENDPOINTPIC+ PrefereUtils.getInstance().getUser().getAvatar(),head_image);
    ...
    @Override public void doStartUnionPayPlugin(Activity activity, String tn, String mode) {
    ...
    private void recharge(String order_no){
       if(payChannel.equals("alipay")){
           ...
           aliPay.payV2(false,currentMoney, "缴费", order_no, new AliPay.AlipayCallBack() {
               @Override
