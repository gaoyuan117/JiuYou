package com.jiuyou.ui.activity.saomiao;
...
import com.jiuyou.ui.activity.YanZhengResultActivity;
import com.jiuyou.ui.activity.saomiao.camera.CameraManager;
import com.jiuyou.ui.activity.saomiao.camera.PlanarYUVLuminanceSource;
import com.jiuyou.ui.activity.saomiao.decoding.CaptureActivityHandler;
import com.jiuyou.ui.activity.saomiao.decoding.InactivityTimer;
import com.jiuyou.ui.activity.saomiao.decoding.RGBLuminanceSource;
import com.jiuyou.ui.activity.saomiao.decoding.Utils;
import com.jiuyou.ui.activity.saomiao.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
    ...
    public void handleDecode(final Result result, Bitmap barcode) {
        ...
        if (resultString.contains("Verify/index")) {
            Intent intent = new Intent(this, YanZhengResultActivity.class);
    ...
    private void goBuy(String product_id) {
