...
public class NetStatusUtils {
    ...
    public static boolean isNetWorkEnableWithoutToast() {
        try {
            ConnectivityManager connectivity = (ConnectivityManager) (BaseApp.getContext())
...
//                type = "Wi-Fi";
    ...
    private static int getNetworkClass() {
        ...
        try {
            final NetworkInfo network = ((ConnectivityManager) UiUtils
                    .getContext()
                    .getSystemService(Context.CONNECTIVITY_SERVICE))
            ...
            if (network != null && network.isAvailable()
                ...
                if (type == ConnectivityManager.TYPE_WIFI) {
                    ...
                    TelephonyManager telephonyManager = (TelephonyManager) UiUtils
    ...
    public static String getWifiRssi() {
        ...
        try {
            ...
            if (network != null && network.isAvailable()
                ...
                int type = network.getType();
                if (type == ConnectivityManager.TYPE_WIFI) {
                    WifiManager wifiManager = (WifiManager) UiUtils
    ...
    public static String getImei() {
        TelephonyManager mTelephonyMgr = (TelephonyManager) UiUtils
