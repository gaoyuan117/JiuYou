...
public final class OverscrollHelper {
    ...
    public static void overScrollBy(final PullToRefreshBase<?> view,
        ...
        // 搜索栏--滚动到最高点并且滚动距离大于搜索栏的高度时显示搜索栏
        if (view.isOpenSearchMode &&
                deltaValue == 0 && scrollValue == 0 && Math.abs(currentScrollValue) >= view.searchBarHeight) {
            view.showRefreshingBarProgress(-view.searchBarHeight);
        }


        Log.d("ssadsada", "deltaValue-" + deltaValue + " scrollValue-" + scrollValue + " " + currentScrollValue);
...
//						Log.d("fdas",
//								"1-currentScrollValue-"
//										+ String.valueOf(currentScrollValue)
//										+ "-newScrollValue-"
//										+ String.valueOf(newScrollValue)
//										+ "-fuzzyThreshold-"
//										+ String.valueOf(fuzzyThreshold)
//										+ "-realScroll-"
//										+ String.valueOf((int) (scaleFactor * (currentScrollValue + newScrollValue))));
