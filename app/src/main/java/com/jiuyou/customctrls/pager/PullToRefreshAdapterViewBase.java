...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    private int listview_firstVisibleItem = 0;
    private int listview_visibleItemCount = 0;
    private int listview_totalItemCount = 0;

    public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
                               final int totalItemCount) {

        listview_firstVisibleItem = firstVisibleItem;
        listview_visibleItemCount = visibleItemCount;
        listview_totalItemCount = totalItemCount;
...
//		}
    ...
    public void onScrollStateChanged(final AbsListView view, final int state) {
        ...
        if (state == OnScrollListener.SCROLL_STATE_IDLE
                ...
                && (listview_totalItemCount > 0) && (listview_firstVisibleItem + listview_visibleItemCount >= listview_totalItemCount)) {
            if (this.curRefreshingMode == PullToRefreshBase.REFRESH_MODE_PULL_END)
                return;
            this.curRefreshingMode = PullToRefreshBase.REFRESH_MODE_PULL_END;
            this.mFooterLayout.refreshing();
//			Log.d("refreshing","q");
            callRefreshListener();
        }
        if (state == OnScrollListener.SCROLL_STATE_IDLE && null != mOnLastItemVisibleListener
                && (listview_firstVisibleItem + listview_visibleItemCount >= listview_totalItemCount)) {
