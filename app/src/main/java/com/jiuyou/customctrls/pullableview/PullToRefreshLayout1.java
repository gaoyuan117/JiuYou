package com.jiuyou.customctrls.pullableview;
...
public class PullToRefreshLayout1 extends RelativeLayout
{
	...
	public PullToRefreshLayout1(Context context, AttributeSet attrs, int defStyle)
	{
	...
	public interface OnRefreshListener
	{
		 ...
		 * 刷新操作
		 */
		void onRefresh(PullToRefreshLayout1 pullToRefreshLayout);

		/**
		 * 加载操作
		 */
		void onLoadMore(PullToRefreshLayout1 pullToRefreshLayout);
	}
