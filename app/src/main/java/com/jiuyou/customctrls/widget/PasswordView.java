...
public class PasswordView extends RelativeLayout {
    ...
    private TextView tv_confirmpay,textAmount;
    ...
    public PasswordView(Context context, AttributeSet attrs) {
        ...
        tv_confirmpay=(TextView) view.findViewById(R.id.tv_confirmpay);
    ...
    public TextView getConfirmPay() {
        return tv_confirmpay;
    }
    public TextView getTextAmount() {
        return textAmount;
    }
    public RelativeLayout getRl_cancle(){
        return  rl_cancle;
    }
}
